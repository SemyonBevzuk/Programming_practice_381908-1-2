...
void FilmLibrary::Change(string title, string producer, string screenwriter, string composer, string data, long long fees)
{
	int index = -1;
...
vector<string> FilmLibrary::Find(string title, int year)
{
...
vector<string> FilmLibrary::MovieSearch(string producer)
{
...
vector<string> FilmLibrary::MovieSearch(int year)
{
...
vector<string> FilmLibrary::NumberFilms(int quantity)
{
...
vector<string> FilmLibrary::NumberFilms(int quantity, int year)
{
...
void FilmLibrary::SaveLibrary() //Сохраняем библиотеку в файл
{
	ofstream fout; //поток
...
void FilmLibrary::ReadLibrary() //Читаем из файла
{
