...
public:
    ...
    int price;
    Ticket();
    Ticket(string Name, int Hall, int Row, int Column, DateTime Date, bool VIP, int price) :
        FilmName(Name), Hall(Hall), Row(Row), Column(Column), Date(Date), VIP(VIP), price(price) {}
